namespace DSRForge.Memory
{
    ...
    public static class Patterns
    {
        ...
        public static readonly Pattern LevelUpFunc = new Pattern(
            new byte[] { 0x48, 0x89, 0x74, 0x24, 0x20, 0x57, 0x48, 0x83, 0xEC, 0x20, 0x48, 0x8B, 0x05, 0x00, 0x00, 0x00, 0x00, 0x4C },
            "xxxxxxxxxxxxx????x",
            0,
            RipType.None);
        
        public static readonly Pattern RestoreCastsFunc = new Pattern(
            new byte[] { 0x48, 0x89, 0x5C, 0x24, 0x08, 0x48, 0x89, 0x74, 0x24, 0x10, 0x57, 0x48, 0x83, 0xEC, 0x30, 0x48, 0x8D, 0x59 },
            "xxxxxxxxxxxxxxxxxx",
            0,
            RipType.None);
        ...
        public static readonly Pattern WarpFunc = new Pattern(
            new byte[] { 0x48, 0x89, 0x5C, 0x24, 0x08, 0x57, 0x48, 0x83, 0xEC, 0x20, 0x48, 0x8B, 0xD9, 0x8B, 0xFA, 0x48, 0x8B, 0x49, 0x08, 0x48, 0x85, 0xC9, 0x0F },
        ...
        public static readonly Pattern TargetingView = new Pattern(
            new byte[] { 0x40, 0x53, 0x48, 0x83, 0xEC, 0x20, 0x48, 0x8B, 0xD9, 0x48, 0x8B, 0x49, 0x08, 0x48, 0x85, 0xC9, 0x74, 0x64 },
            "xxxxxxxxxxxxxxxxxx",
            0,
            RipType.None);
